...
public class planetKepler extends planetMars{
    private String name = "KEPLER";
    private final String imagePath = "file:src/main/resources/org/example/demo1/planetKepler.png";
    private ArrayList<LightPlane> currentPlanes = new ArrayList<>();
    public planetKepler(int x, int y, Group group) {
        super(x, y, group);
    }
    public planetKepler(Group group){
        super(500, 200, group);
    }
